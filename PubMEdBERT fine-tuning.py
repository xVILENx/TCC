...
# Usaremos o PubMedBERT para token classification (NER)
...
gene_list = load_gene_list("C:/Users/vilen/VScode/Tcc/gene_id_list.13") # path da lista
...
new_test_texts = [
    ...
    "LZTFL1 is associated with COVID-19",
    "APOE gene variants increase Alzheimer's risk.",
    "The PSEN1 gene increases the risk of deveelping Alzheimer."
]
